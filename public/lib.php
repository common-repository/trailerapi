...
$wpdb->update( 
	...
	update_option('LTM_version','1.2');
		...
		if($ltm_version=="1.2"){
		$update_sql="ALTER TABLE $ltm_options  CHANGE width width VARCHAR(4) NOT NULL; ";
	$wpdb->query($update_sql);
		$update_sql="ALTER TABLE $ltm_options  CHANGE height height VARCHAR(4) NOT NULL; ";
	$wpdb->query($update_sql);
		update_option('LTM_version','1.3');
		}
	}
?>